...
<meta name="Generator"
	content="Projeto BoletoPHP - www.boletophp.com.br - Licen�a GPL" />
<style type=text/css>
...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
	<div id="container">
		<div id="instr_header">
			<img height="65" width="160" src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/resources/logos/<?= $dadosboleto ["id_empresa"] ?>.png"/>
...
<!-- 		<tr> -->
<!-- 			<td valign=top class=cp><DIV ALIGN="CENTER">Instru��es de Impress�o</DIV></TD> -->
<!-- 		</TR> -->
<!-- 		<TR> -->
...
<!-- 						qualidade normal ou alta (N�o use modo econ�mico).<br> -->
					
<!-- 					<li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e -->
<!-- 						margens m�nimas � esquerda e � direita do formul�rio.<br> -->
					
<!-- 					<li>Corte na linha indicada. N�o rasure, risque, fure ou dobre a -->
<!-- 						regi�o onde se encontra o c�digo de barras.<br> -->
					
<!-- 					<li>Caso n�o apare�a o c�digo de barras no final, clique em F5 para -->
<!-- 						atualizar esta tela. -->
					
<!-- 					<li>Caso tenha problemas ao imprimir, copie a seq�encia num�rica -->
<!-- 						abaixo e pague no caixa eletr�nico ou no internet banking:<br> -->
<!-- 					<br> <span class="ld2"> -->
<!-- 					</span> -->
...
<!-- 	</table> -->
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tr>
			<td class=cp width=150><span class="campo">
				<IMG src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/logobradesco.jpg" width="150" height="40" border=0></span></td>
			<td width=3 valign=bottom>
				<img height=22 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/3.png" width=2 border=0></td>
		...
		<tbody>
			<tr>
				<td colspan=5><img height=2 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png" width=666 border=0></td>
			</tr>
		</tbody>
	</table>
	<table cellspacing=0 cellpadding=0 border=0  style="border-right: solid 1px black;">
		<tbody>
			<tr>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=ct valign=top width=298 height=13>Cedente</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=ct valign=top width=126 height=13>Agência/Código do
					Cedente</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
			...
			<tr>
				<td class=cp valign=top width=7 height=12><img height=12 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				...
				<td class=cp valign=top width=7 height=12><img height=12 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top align=right width=120 height=12><span class="campo"><?php echo $dadosboleto["nosso_numero"]?>
  </span></td>
			</tr>
			<tr>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=298 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=298 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=126 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=126 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=34 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=34 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=53 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=53 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=120 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
  ...
  <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=113 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=113 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=72 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=72 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=132 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=132 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=134 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=134 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=180 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
	...
	<table cellspacing=0 cellpadding=0 border=0  style="border-right: solid 1px black;">
		<tbody>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=112 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
  ...
  <?php echo $dadosboleto["sacado"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=659 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
  ...
  <?php echo $dadosboleto["demonstrativo3"]?><br>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		...
		<tbody>
			...
			<tr>
				<td class=ct width=666><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/6.png" width=665
					border=0></td>
			</tr>
		</tbody>
	</table>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0 >
		<tr>
			<td class=cp width=150><span class="campo"><IMG
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/logobradesco.jpg" width="150" height="40" border=0></span></td>
			<td width=3 valign=bottom><img height=22 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/3.png" width=2
				border=0></td>
...
<?php echo $dadosboleto["linha_digitavel"]?>
	...
	<table cellspacing=0 cellpadding=0 border=0  style="border-right: solid 1px black;">
		<tbody>
			...
			<tr>
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top width=472 height=12>Pagável em qualquer
					Banco até o vencimento</td>
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top align=right width=180 height=12><span
					class="campo">
  <?php echo $dadosboleto["data_vencimento"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=472 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=472 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=180 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=180 border=0></td>
	...
	<table cellspacing=0 cellpadding=0 border=0 style="border-right: solid 1px black;">
		<tbody>
			<tr>
				...
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=ct valign=top width=153 height=13>Nº documento
				</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				...
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=ct valign=top width=82 height=13>Data processamen.</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
  ...
  <?php echo $dadosboleto["data_documento"]?>
				...
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top width=153 height=12><span class="campo">
    <?php echo $dadosboleto["numero_documento"]?>
    </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top width=62 height=12><div align=left>
						<span class="campo">
 ...
 <?php echo $dadosboleto["aceite"]?>
   ...
   <?php echo $dadosboleto["data_processamento"]?>
     ...
     <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=153 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=153 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=62 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
				...
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=82 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
  ...
  <?php echo $dadosboleto["carteira"]?>
				...
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top width=53><div align=left>
						<span class="campo">
<?php echo $dadosboleto["especie"]?>
 ...
 <?php echo $dadosboleto["quantidade"]?>
				...
				<td class=cp valign=top width=7 height=12><img height=12
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
				<td class=cp valign=top width=72><span class="campo">
   ...
   <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=31 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=31 border=0></td>
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=83 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
				...
				<td valign=top width=7 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=7 border=0></td>
				<td valign=top width=123 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
	...
	<table cellspacing=0 cellpadding=0 width=667 border=0>
		<tbody>
			<tr>
				<td align=right width=10><table cellspacing=0 cellpadding=0 border=0
						align=left >
						<tbody>
							<tr>
								<td class=ct valign=top width=7 height=13><img height=13
...
<?php echo $dadosboleto["instrucoes4"]; ?></FONT><br>
				...
				<td align=right width=188><table cellspacing=0 cellpadding=0
						border=0 style="border-right: solid 1px black;">
						<tbody>
							<tr>
								<td class=ct valign=top width=7 height=13><img height=13
									src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
							...
							<tr>
								...
								<td valign=top width=180 height=1><img height=1
									src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png" width=180 border=0></td>
							</tr>
						</tbody>
					</table></td>
			</tr>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0 width=667 style="border-right: solid 1px black;">
		<tbody>
			<tr>
				<td valign=top width=666 height=1><img height=1 src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/2.png"
					width=666 border=0></td>
			</tr>
		</tbody>
	</table>
	<table cellspacing=0 cellpadding=0 border=0 width=667 style="border-right: solid 1px black;">
		<tbody>
			<tr>
				<td class=ct valign=top width=7 height=13><img height=13
					src="http://<?= $_SERVER['HTTP_HOST'] ?>/iboltpag/util/boletos/imagens/1.png" width=1 border=0></td>
